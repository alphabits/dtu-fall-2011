...
\usepackage{fancyhdr}
\pagestyle{fancy}
\lhead{\small\textit{02610 Optimization and Data Fitting -- Anders Hørsted (s082382)}}
\rhead{\thepage}
\chead{}
\lfoot{}\cfoot{}\rfoot{}
...
\newcommand\coderemark[1]{\textit{See \appref{#1} for code used in this exercise}.}
...
\date{\assignmentdate}
\author{02610 Optimization and Data Fitting -- Anders Hørsted (s082382)}
%\author{}
